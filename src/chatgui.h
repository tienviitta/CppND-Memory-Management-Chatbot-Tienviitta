...
private:
    ...
    // In file chatgui.h / chatgui.cpp, make _chatLogic an exclusive resource
    // to class ChatbotPanelDialog using an appropriate smart pointer. Where
    // required, make changes to the code such that data structures and
